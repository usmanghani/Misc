...
namespace testmicrolibsearch
{
    public class Book
    {
        ...
        , Description("Directory which contains the files of the book."), DisplayName("Directory Name")]
        ...
        [DisplayName("Is Directory"), Description("Specifies whether the book's data is in the files in a directory, or a single file.")]
