...
namespace DotFermion.Highlighting
{
    public class ResultHighlighter
    {
        ...
        public string CreateHtmlHeaders()
        {
            return "<html><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><style>.highlight{background:yellow;}</style><body>";
        }

        public string CreateHtmlTrailers()
        {
            return "</body></html>";
