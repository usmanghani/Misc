...
using DotFermion.IFilters;

namespace DotFermion.Indexing
{
    ...
    public class Indexer
    {
        ...
        public void IndexDirectory(string path)
        {
            ...
            //StreamWriter logger = File.CreateText("c:\\indexlog.txt");
            ...
            foreach (string s in files)
            {
                ...
                try
                {
                    ...
                    if (DefaultParser.IsParseable(s))
                    {
                        contents = DefaultParser.Extract(s);
