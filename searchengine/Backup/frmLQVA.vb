...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents grd As AxMSHierarchicalFlexGridLib.AxMSHFlexGrid
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grd = New AxMSHierarchicalFlexGridLib.AxMSHFlexGrid()
...
#End Region
    ...
    Private Sub grd_DblClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grd.DblClick
    ...
    Private Sub ArabicUrduEnglish()
        ...
        If Not (Rs.EOF Or Rs.BOF) Then
            For i = 0 To Rs.RecordCount - 1
                ...
                grd.CellForeColor = Color.DarkGreen
                grd.WordWrap = True
                ...
                grd.CellFontSize = 10
                grd.CellForeColor = Color.Maroon 'DarkGoldenrod
                grd.WordWrap = True
